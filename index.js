...
document.addEventListener('DOMContentLoaded', function () {
  const evenementsSection = document.querySelector('#evenements .menu-item-container');
  if (evenementsSection) {
    evenementsSection.style.cursor = 'pointer';
    evenementsSection.addEventListener('click', function () {
      window.location.href = 'evenement.html'; // redirection vers fichier local
    });
  }
});
document.addEventListener('DOMContentLoaded', function () {
  const evenementsSection = document.querySelector('#Activités .menu-item-container');
  if (evenementsSection) {
    evenementsSection.style.cursor = 'pointer';
    evenementsSection.addEventListener('click', function () {
      window.location.href = 'activité.html'; // redirection vers fichier local
    });
  }
});

document.addEventListener('DOMContentLoaded', function () {
  const evenementsSection = document.querySelector('#Administration .menu-item-container');
  if (evenementsSection) {
    evenementsSection.style.cursor = 'pointer';
    evenementsSection.addEventListener('click', function () {
      window.location.href = 'administration.html'; // redirection vers fichier local
    });
  }
});

document.addEventListener('DOMContentLoaded', function () {
  const evenementsSection = document.querySelector('#Bénévoles .menu-item-container');
  if (evenementsSection) {
    evenementsSection.style.cursor = 'pointer';
    evenementsSection.addEventListener('click', function () {
      window.location.href = 'benevoles.html'; // redirection vers fichier local
    });
  }
});

document.addEventListener('DOMContentLoaded', function () {
  const evenementsSection = document.querySelector('#Productions .menu-item-container');
  if (evenementsSection) {
    evenementsSection.style.cursor = 'pointer';
    evenementsSection.addEventListener('click', function () {
      window.location.href = 'production.html'; // redirection vers fichier local
    });
  }
});
